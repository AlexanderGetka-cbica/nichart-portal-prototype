import { Authenticator, Collection, ScrollView, Button, Flex, Heading, Image, Text, Divider, FileUploader, Loader, Link, Badge } from '@aws-amplify/ui-react';
import { StorageManager } from '@aws-amplify/ui-react-storage';
import '@aws-amplify/ui-react/styles.css';
import { Amplify, Auth, Storage } from 'aws-amplify';
import awsconfig from './aws-exports';

import { BatchClient, CancelJobCommand, ListJobsCommand, DescribeJobsCommand, ListTagsForResourceCommand } from "@aws-sdk/client-batch";

import React from 'react'
import { useState, useEffect } from 'react';

// Base config (input) -- may need to re-config for getting output, then refresh
...
function App() {
  ...
  {({ signOut, user }) => (
    <div>
    <Flex direction = {{ base: 'row' }} height="60px" justifyContent="space-between">
    <Heading level={1}> niCHART Pipelines Demo </Heading>
    <div>
